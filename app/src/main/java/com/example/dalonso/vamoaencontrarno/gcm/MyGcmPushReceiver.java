...
public class MyGcmPushReceiver extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle bundle) {
        ...
        /*if(MainActivity.getInstance().getPrefManager().getUser() == null){
        ...
        switch (Integer.parseInt(flag)) {
            ...
            case Config.PUSH_TYPE_USER:
                ...
                break;
            case Config.PUSH_TYPE_USER_COPA:
                // push notification is specific to user
                processUserMessage(title, isBackground, data);
                break;
            case Config.PUSH_TYPE_USER_PERREA:
                // push notification is specific to user
                processUserMessage(title, isBackground, data);
                break;
            case Config.PUSH_TYPE_USER_BRONCA:
                // push notification is specific to user
                processUserMessage(title, isBackground, data);
                break;
        }
...
//                if (uObj.getString("user_id").equals(MainActivity.getInstance().getPrefManager().getUser().getId())) {
...
//                }
                ...
                if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                    ...
                    //MainActivity.getInstance().getPrefManager().cancelAllNotifications();
    ...
    private void processUserMessage(String title, boolean isBackground, String data) {
        if (!isBackground) {
            ...
            try {
                ...
                message.setMessage(mObj.getString("message"));
                message.setId(mObj.getString("message_id"));
                message.setChatRoomId(mObj.getString("chat_room_id"));
                message.setCreatedAt(mObj.getString("created_at"));
